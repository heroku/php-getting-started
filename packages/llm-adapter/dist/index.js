...
async function embedAzure(text, config) {
    if (!azureClient) {
...
async function generateAzure(prompt, config) {
    if (!azureClient) {
        azureClient = new OpenAI({
            apiKey: config.apiKey,
            baseURL: config.baseURL,
...
async function generateOllama(prompt, config) {
...
async function rerankOllama(query, passages, config) {
...
async function embedHuggingFace(text, config) {
...
async function generateHuggingFace(prompt, config) {
