...
*/
ob_start();
define('API_KEY','5150951993:AAGElm3mnr6ZTTnyp9TLGhHfZVCqf058gcg'); // توکن ربات
...
$Dev = array("240142124","777000","102092512"); // ایدی عددی ادمین ها ، ادمین اصلی اول
$Dev1 = array("240142124","777000","102092512"); // ایدی عددی ادمین ها ، ادمین اصلی اول
@$usernamebot = "iranibobot"; // یوزرنیم ربات
@$channel = "hi_php_co"; // ادرس کانال
@$token = API_KEY;
//-----------------------------------------------------------------------------------------------
...
$msg = $settings["information"]["lastmsgadd"];
			...
			'parse_mode'=>"MarkDown",
                'chat_id'=>$chat_id,
                'text'=>"کاربر ( [$first_name](tg://user?id=$from_id) )
...
if (strstr($textmassage,"کسده") == true  or strstr($textmassage,"جنده") == true or strstr($textmassage,"کیر") == true  or  strstr($textmassage,"سکسی") == true   or strstr($textmassage,"ازدواج") == true) {
if ($tc == 'group' | $tc == 'supergroup'){
if ( $status != 'creator' && $status != 'administrator' && !in_array($from_id,$Dev) ){
	bot('deletemessage',[
    'chat_id'=>$chat_id,
...
elseif ($textmassage == '📌 فوروارد به گروه' && in_array($from_id,$Dev)) {
    ...
    'keyboard'=>[
	[
	['text'=>"برگشت🔙",'callback_data'=>"managemant_group"] 
	]
   ],
      'resize_keyboard'=>true
   ])
...
'reply_to_message_id'=>$message_id,
      ...
      'inline_keyboard'=>[
     [
    ['text'=>"🥒خیار🥒", 'url'=>"https://t.me/Khiyyaar"]
    ],
    ]
    ])
   ]);
...
// kick
elseif($textmassage=="/kick" or $textmassage=="kick" or $textmassage=="اخراج"){
if ( $status == 'creator' or in_array($from_id,$Dev)) {
bot('sendmessage',[
'parse_mode'=>"MarkDown",
'chat_id'=>$chat_id,
'text'=>"» کاربر  ( [$re_id](tg://user?id=$re_id) ) از گروه اخراج شد.",
'reply_to_message_id'=>$message_id,
   'reply_markup'=>json_encode([
      'inline_keyboard'=>[
     [
...
'reply_to_message_id'=>$message_id,
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"خرید ربات",'url'=>"https://t.me/official_hafiz"]
	],
              ],
        ])
   ]);
...
if($textmassage=="/start" && $tc == "private" or $textmassage=="/panel" && $tc == "private"){
	...
	bot('sendmessage',[
	'chat_id'=>$chat_id,
	'text'=>"سلام$name به ربات ضد لینک PF خوش آمدید✔️
توسط ربات ما میتونی به سادگی گروهتو بصورت کاملا پیشرفته مدیریت کنی
...
'reply_to_message_id'=>$message_id,
    ...
    'inline_keyboard'=>[
                [
                ['text'=>"⇜ خرید اشتراک ⇜ ",'callback_data'=>'kharid2'],['text'=>"⇜ توانایی های ربات ⇜",'callback_data'=>'aboutus']
                ],
				[
                ['text'=>"⇜ درخواست پشتیبانی ⇜",'callback_data'=>'poshtibanipv']
                ],
                [
				['text'=>"⇜ کانال تیم ما ⇜",'url'=>"https://telegram.me/$channel"]
                ],
...
'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"ورود به کانال",'url'=>"https://t.me/hi_php_co"]
	],
              ]
        ])
            ]);
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				[
                ['text'=>"⇜  خرید اشتراک ⇜ ",'url'=>'https://t.me/hi_php_co'],['text'=>"⇜  اشتراک رایگان ⇜ ",'callback_data'=>'freepv']
                ],    
			    [
...
'reply_markup'=>json_encode([
   ...
   elseif($data=="aboutus"){
            bot('editmessagetext',[
                'chat_id'=>$chatid,
     'message_id'=>$messageid,
               'text'=>"توانایی های ربات PF🔲

سرعت بالا
امکانات فوق العاده
مدیریت 24  ساعته
حذف پیام های تبلیغاتی و ربات های مزاحم
ضد لینک PF همون چیزی که در نظر داری رو برات فراهم میکنه
",
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				[
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                [
                    ['text'=>"اضافه کردن ربات به گروه",'url'=>'https://t.me/PFro_bot?startgroup=add']
                ],
				[
                    ['text'=>"بازگشت 🔙",'callback_data'=>'backpv']
                ],
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                [
                    ['text'=>"کد پشتیبان : 22",'url'=>'https://t.me/hi_php_co']
                ],
                ]
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                [
                    ['text'=>"کد پشتیبان : 13",'url'=>'https://t.me/hi_php_co']
                ],
                ]
...
» لطفا بخش مورد نظر خورد را انتخاب کنید",
	  ...
	  ['text'=>"عمومی",'callback_data'=>"allen"],['text'=>"مدیریتی",'callback_data'=>"manageen"]
	  				    	...
	  				    	[
	  ['text'=>"قفل ها",'callback_data'=>"locken"],['text'=>"سودو",'callback_data'=>"sudohelpen"]
	  ],
					 [
...
",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
					 [
					 ['text'=>"بازگشت 🔙",'callback_data'=>'english']
					 ],
                     ]
               ])
           ]);
...
",
               'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
					 [
					 ['text'=>"بازگشت 🔙",'callback_data'=>'farsi']
					 ],
                     ]
               ])
           ]);
